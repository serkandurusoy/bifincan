...
@Named("productNoStockListAction")
@Scope(ScopeType.VIEW)
public class ProductOutOfStockListAction implements Serializable {
	private static final long serialVersionUID = -2826827408608752150L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ProductOutOfStockListAction.class);
	...
	public ProductOutOfStockListAction() { }
	...
	/**
	 * This method is used in order to set-up a list of OUT-OF-STOCK products ready for rendering.
	 */
	public void loadProducts() {
		...
		if(principal != null) {
			...
			List<Product> productRecords = productService.findOutOfStockProducts(user);

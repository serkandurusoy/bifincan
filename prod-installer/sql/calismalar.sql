...
select * from user where firstname like '%Ömer%' order by firstname,lastname collate utf8_general_ci;
select * from user where lastname like '%karaman%' order by lastname,firstname collate utf8_general_ci;
select * from user where email like '%muslera%' order by email;
select * from user where id in (2629,2648,2705);
...
select * from user where id in (select invited_by from user_invitation where id in (select user_invitation from user where id in (3310)));
select * from user where user_invitation in (select id from user_invitation where invited_by in (1934));
select * from orders where address_id in (select id from address where user in (1832));
select * from order_details where order_id in (select id from orders where address_id in (select id from address where user in (8)));
select * from product where id in (select product_id from order_details where order_id in (select id from orders where address_id in (select id from address where user in (3305))));
select * from user_login where user in (3414,3415,1934) order by ip_address desc;
select * from user_invitation where invited_by = 3222;
...
where u.id in (3416,1934,3414,3415) and
...
'fre_ebum@hotmail.com',
'tolayttt@hotmail.com',
'nuraykoseli@hotmail.com',
'ayfercakir1963@hotmail.com',
'daybuyday001@hotmail.com',
'isabaltaci@helyum.com.tr',
'severim_onu98@hotmail.com',
'ibrahim.uncu@mynet.com',
'nuray.kahveci@darty.com.tr',
'acaglayan@hayat.com.tr',
'evgenya@fikrisahane.org',
'emirbabul@firststepmedya.com',
'',
'',
'',
'',

/*KULLANICI SAYISI*/
select count(*) as users from user where active;

/*YAYINDA GÜN SAYISI*/
select datediff(curdate(),min(login_time))+1 as yayin_gunu from user_login;

/*CEVAPLANAN SORU SAYISI*/
select count(*) from survey_answer_option where survey_answer_id in (select id from survey_answer where user_id in (select id from user where active));

/*GÜNDE ORTALAMA CEVAPLANAN SORU SAYISI*/
select (select count(*) from survey_answer_option where survey_answer_id in (select id from survey_answer where user_id in (select id from user where active)))/(select datediff(curdate(),min(login_time)+1) as yayin_gunu from user_login);

/*KULLANICI BAŞINA ORTALAMA CEVAPLANAN SORU SAYISI*/
select (select count(*) from survey_answer_option where survey_answer_id in (select id from survey_answer where user_id in (select id from user where active)))/(select count(*) as users from user where active);

/*GÜNDE KULLANICI BAŞINA ORTALAM CEVAPLANAN SORU SAYISI*/
select 
    (select count(*) from survey_answer_option where survey_answer_id in (select id from survey_answer where user_id in (select id from user where active)))
    /
    (select avg(datediff(curdate(),create_date)+1) from user where active)
    /
    (select count(*) as users from user where active)
;
...
select 
    ...
    count(*), 
    count(*)/(select count(*) from user where active)*100 as yuzde 
from 
    user 
where
    active
...
select 
    ...
    count(gender), 
    count(gender)/(select count(*) from user where active)*100 as yuzde 
from 
    user
where
    active
...
select 
    ...
    count(has_children), 
    count(has_children)/(select count(*) from user where active)*100 as yuzde 
from 
    user 
where
    active
...
select 
    ...
    count(marital_status)/(select count(*) from user where active)*100 as yuzde 
from 
    user 
where
    active
...
select 
    ...
    count(employment_status)/(select count(*) from user where active)*100 as yuzde 
from 
    user 
where
    active
...
select 
    ...
    count(education_type)/(select count(*) from user where active)*100 as yuzde 
from 
    user 
where
    active
...
select 
    ...
    count(monthly_income)/(select count(*) from user where active)*100 as yuzde 
from 
    user
where
    active
...
select
    ci.name,
    count(ci.name),
    count(ci.name)/(select count(*) from user where active)*100 as yuzde,
